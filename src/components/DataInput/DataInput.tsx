...
const TableRow: React.FC<TableRowProps> = ({
  ...
  return (
    <div
      className={`flex items-stretch w-full h-14 py-2 bg-light-background dark:bg-dark-background ${
        isUnactivated ? "sticky bottom-0" : ""
      }`}
    >
      <div className="flex items-center justify-center w-12 flex-shrink-0 text-light-text-secondary dark:text-dark-text-secondary relative">
        {row.assignment !== null && !isUnactivated && (
          <Flipped flipId={row.assignmentOriginalIndex || index}>
            <div
              className={`absolute w-8 h-8 rounded-md ${assignmentColor} opacity-30`}
